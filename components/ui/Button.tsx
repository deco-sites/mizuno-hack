...
const variants = {
	...
	icon:
		'h-[36px] px-2 rounded-full text-default border-transparent hover:bg-hover active:border-interactive disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none',
	slider: 'w-10 h-10 rounded outline-none bg-gray-100',
}
