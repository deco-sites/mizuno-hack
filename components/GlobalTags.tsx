      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `@font-face {
            font-family: 'Roboto';
            src: url('${
            asset("/fonts/roboto/Roboto-Medium.woff2")
          }') format('woff2'),
                url('${
            asset("/fonts/roboto/Roboto-Medium.woff")
          }') format('woff');
            font-weight: 500;
            font-style: normal;
            font-display: swap;
        ...
        @font-face {
            font-family: 'Roboto';
            src: url('${
            asset("/fonts/roboto/Roboto-Regular.woff2")
          }') format('woff2'),
                url('${
            asset("/fonts/roboto/Roboto-Regular.woff")
          }') format('woff');
            font-weight: normal;
            font-style: normal;
            font-display: swap;
        ...
        @font-face {
            font-family: 'Roboto';
            src: url('${
            asset("/fonts/roboto/Roboto-Bold.woff2")
          }') format('woff2'),
                url('${
            asset("/fonts/roboto/Roboto-Bold.woff")
          }') format('woff');
            font-weight: bold;
            font-style: normal;
            font-display: swap;
            ...
            font-display: swap;
				...
				@font-face {
					font-family: 'Roboto';
					src: url('${
            asset("/fonts/roboto/Roboto-Black.woff2")
          }') format('woff2'),
